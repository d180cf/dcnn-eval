...
2. Each tsumego is solved and a tree of subproblems is generated. There is usually about 1000-2000 subproblems per each original problem.
...
6. Finally the set of ~10M feature tensors with labels is converted to a TensorFlow format and saved as a python package.
